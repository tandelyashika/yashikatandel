    ...
    <div className="flex items-center h-full justify-between">
        ...
        <div className="flex items-center gap-4 md:gap-7">
            <nav className="flex gap-4 md:gap-6 text-base md:text-lg hidden md:flex">
                <Link to={""}>Home</Link>
                <Link to={"menu/65192b64fb6786621c1e7e31"}>Menu</Link>
            ...
            <div className="text-slate-600" onClick={  handleShowMenu }>
                <div className="text-3xl cursor-pointer w-10 h-10 rounded-full overflow-hidden drop-shadow-md">
                    {userData.image ? <img src={userData.image } className="h-full w-full"/> : <BiSolidUserCircle/> }
                </div>
                {showMenu && (
              <div className="absolute right-2 bg-white py-2  shadow drop-shadow-md flex flex-col min-w-[120px] text-center">
               {
                ...
                <nav className="text-base md:text-lg flex flex-col md:hidden">
                  ...
                  <Link
                    to={"menu/65192b64fb6786621c1e7e31"}
                    className="px-2 py-1"
                  >
                    Menu
                  </Link>
